...
public class MinusQuestion {
    ...
    public MinusQuestion (int upperLimit){
        this.upperLimit=upperLimit;
        Random randomNumberMaker= new Random();
        this.firstNumber=  randomNumberMaker.nextInt(upperLimit);
        this.secondNumber= randomNumberMaker.nextInt(upperLimit);
        this.answer= this.secondNumber - this.firstNumber;  // toplama çıkarma değiştir.
        this.questionPhrase=secondNumber+"-"+firstNumber+"=";  //toplama çıkarma değiştir.
